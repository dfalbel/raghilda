...
from typing import Any, Mapping, Optional, Sequence, Callable, TYPE_CHECKING, Union
...
class ChromaDBStore(BaseStore):
    ...
    def ingest(
        ...
        num_workers
            The number of worker threads to use for parallel ingestion. If None, defaults
