...
The `retrieve()` method combines vector similarity search (semantic matching) with BM25 (keyword matching) for hybrid retrieval. By default, overlapping chunks from the same document are merged (`deoverlap=True`) to provide more coherent results.
...
- Learn schema-based retrieval scoping with [Attribute Filters](03-metadata-filters.qmd)
